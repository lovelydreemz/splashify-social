...
serve(async (req) => {
  ...
  try {
    ...
    if (!createContainerResponse.ok) {
      ...
      console.error("Instagram API error (create container):", errorText);
      return new Response(JSON.stringify({ error: "Failed to create Instagram post container", details: errorText }), {
    ...
    if (!publishResponse.ok) {
      ...
      console.error("Instagram API error (publish):", errorText);
      return new Response(JSON.stringify({ error: "Failed to publish Instagram post", details: errorText }), {
    ...
    console.log("Post published successfully:", instagramPostId);
